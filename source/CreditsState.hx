...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			["FNF' HD PE Port Team"],
			['Nuno Filipe Studios',	'nuno',				'Main porter, programmer, animator',						'https://www.youtube.com/channel/UCq7G3p4msVN5SX2CpJ86tTw',	'878787'],
			...
			['Rozebud',				'roze',				'Coder, Racing',											'https://twitter.com/helpme_thebigt',	'444444'],
			['Smokey',				'smokey',			'Coder',													'https://twitter.com/Smokey_5_',		'4D5DBD'],
			['bb-panzu',			'bb',				'Coder',													'https://twitter.com/bbsub3',			'389A58'],
			['GenoX',				'geno',				'Coder',													'https://twitter.com/GenoXACT2',		'444444'],
			['KadeDev',				'kade',				'Coder',													'https://twitter.com/kade0912',			'64A250'],
			['Flippy',				'flippy',			'Charter',													'https://www.youtube.com/channel/UCMIGpjyL6H__IFp7emWErlw',	'444444'],
			['Chromatical',			'chroma',			'Charter',													'https://twitter.com/Chromaatical',		'444444'],
			['Cval',				'cval',				'Charter',													'https://twitter.com/cval_brown',		'444444'],
			['Saicronise',			'Saicro',			'South rechart',											'https://twitter.com/Saicronise2',		'444444'],
			['JellyFish',			'Jelly',			'All remixes minus Monster',								'https://twitter.com/JellyComics',		'444444'],
			['RetroSpecter',		'retro',			'Helped with MILF remix',									'https://twitter.com/RetroSpecter_',	'444444'],
			['Saster',				'saster',			'Helped with Dadbattle remix',								'https://twitter.com/sub0ru',			'444444'],
			['JADS',				'jads',				'Week 3 bg music, Green Hill',								'https://twitter.com/Aw3somejds',		'444444'],
			['Leukuh',				'leuk',				'Gallery, Boom',											'https://twitter.com/Leukuh',			'444444'],
			['MarblePawns',			'marble',			'Breaking Point, Happy Time, Breaking Point Composer',		'https://twitter.com/marblepawns',		'444444'],
			['Kazuya',				'kazuya',			'Helped with Winter Horrorland',							'https://www.youtube.com/c/KazuyaJcore','444444'],
			['shinseinaken',		'shin',				'Additional dialogue help',									'https://twitter.com/shinseinakenxrd',	'444444'],
			['lattebuns',			'latte',			'(Current) Icon redesigner and help with billboards, Week 5 display screen artist',	'https://twitter.com/LatteBunss','444444'],
			['DOJIMADOG',			'doji',				'(Old) Icon redesigner',									'https://twitter.com/DojimaDog',		'444444'],
			['Akairosu_',			'akai',				'Billboard artist',											'https://twitter.com/akairosu_',		'444444'],
			['peep_face',			'peep',				'Billboard artist',											'https://twitter.com/peep_face',		'444444'],
			['aka_goshhhh',			'aka',				'Week 5 display screen artist',								'https://twitter.com/aka_goshhhh',		'444444'],
			['POSTBOY',				'post',				'Week 5 display screen artist',								'https://twitter.com/P0STBOY',			'444444'],
			['sushiisiu',			'sushi',			'Loading screen artist',									'https://twitter.com/sushiisiu',		'444444'],
			['TentaRJ',				'tenta',			'Mac Build',												'https://twitter.com/TentaRJ',			'444444'],
			['cinnacider',			'cinna',			'Mimmicking Balloon Boy in Spookeez',						'https://twitter.com/cinnacider',		'444444'],
